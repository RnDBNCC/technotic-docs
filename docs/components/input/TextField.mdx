...
- Small
  <Input.TextField inputSize={"small"} />
...
- Medium (default)
  <Input.TextField inputSize={"medium"} />
...
- Large
  <Input.TextField inputSize={"large"} />
...
<Input.TextField borderRadius={"30px"} />
<br />
...
<form>
  <Input.TextField iconLeft={contact} backgroundButtonColor={"#22539F"} />
</form>{" "}
...
<form>
  <Input.TextField textButton={"search"} backgroundButtonColor={"#22539F"} />
</form>
