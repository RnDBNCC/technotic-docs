...
2.  #### <a href={'https://dev.to/couchcamote/git-branching-name-convention-cch'} style={{color: '#22539F'}}>Branch Naming Convention</a>
    ...
    ##### <a href={'https://www.youtube.com/watch?v=BngtN4rUCYo'} style={{color: '#22539F'}}>C. Experimental Branches</a>
    ...
    ##### <a href={'https://www.youtube.com/watch?v=BngtN4rUCYo'} style={{color: '#22539F'}}>D. Build</a>

    ![Deployment](/img/branch-rules/BuildBranch.png)
    ...
    ##### <a href={'https://www.youtube.com/watch?v=BngtN4rUCYo'} style={{color: '#22539F'}}>E. Release</a>

    ![Deployment](/img/branch-rules/ReleaseBranch.png)
    ...
    ##### <a href={'https://www.youtube.com/watch?v=BngtN4rUCYo'} style={{color: '#22539F'}}>F. Merging</a>
