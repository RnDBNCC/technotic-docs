...
There are 5 type of BNCC Button, which are:
...
There are 5 types of BNCC Button can be colorized, which are:
...
- Default Color <span style={{color: 'black', fontWeight: 800}}>(Black)</span>

    <Button btnType="default" btnColor="black">Default</Button>
```tsx
// Color Black
<Button btnType="default" btnColor="black">
    Default
</Button>
```
